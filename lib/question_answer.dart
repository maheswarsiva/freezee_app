          ...
          child: Column(
            children: [
              Container(
                ...
                child: Center(child: Text('Q&A For Add',style: TextStyle(color: Colors.white,fontSize: 18.sp),)),
              ),
              Container(
                height: 595.h,
                width: 340.w,
                ...
                child: Column(
                  ...
                  children: [
                    Padding(padding: EdgeInsets.only(top: 8,bottom: 20,left: 10),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        textfielddata(widget:  TextFormField(

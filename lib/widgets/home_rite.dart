              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: InkWell(child: Text('X',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 15.sp),),
                      onTap: (){
                ...
                InkWell(
                  child: Container(
                    width: 329.w,
                    height: 56.h,
                    margin: EdgeInsets.only(top: 25, left: 16.9.w, right: 16.9.w),
                    decoration: BoxDecoration(

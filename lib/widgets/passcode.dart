...
class OTPWidget extends StatefulWidget {
  ...
  final bool? register;
  const OTPWidget({Key? key, this.forgotPassword, this.register}) : super(key: key);
...
class _OTPWidgetState extends State<OTPWidget> {
            ...
            child: Container(
              ...
              child: Stack(
                children: [
                  Column(
                    children: [
                      const SizedBox(height: 34.6,),
                      const Text('OTP Verification', style: TextStyle(fontSize: 24, fontWeight: FontWeight.w400),),
                      const SizedBox(height: 17.83,),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          _otp(1, textFirstFocusNode),
                          const SizedBox(width: 15.73,),
                      ...
                      const SizedBox(height: 26.84,),
                      Padding(
                        padding: const EdgeInsets.symmetric(horizontal: 12),
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: const [
                            Text('1:30 sec', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w400, color: AppColors.hintTextColor),),
                            Text('Re-send OTP', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w400, color: AppColors.hintTextColor),)
                          ],
                        ),
                      ),
  ...
  Widget _closeBox() => Container(
    ...
    child: Center(
      child: InkWell(onTap: () => Navigator.pop(context), child: const Icon(Icons.clear, size: 20, color: Color.fromRGBO(96, 108, 103, 1),),),
    ),
  );
}

      ...
      body: SafeArea(
        child: Column(
          ...
          children: [
            ...
            StackContainer( height: 240.h,child: Column(
              mainAxisAlignment: MainAxisAlignment.spaceAround,
              children: [
                SizedBox(height: 20.h,),
                Textfield1(titlle: 'NEW PASSWORD', icon: Icon(Icons.vpn_key_outlined,color: AppColors.iconColor,)),
                Textfield1(titlle: 'NEW PASSWORD', icon: Icon(Icons.vpn_key_outlined,color: AppColors.iconColor,)),
                InkWell(
                  child: Container(
                      height: 44.h,
                  ...
                  onTap: (){
                    ...
                    Navigator.push(context, PageTransition(child: OTPWidget(), type: PageTransitionType.leftToRight,

        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Center(child: Text('Transaction Details',style: TextStyle(color: Colors.white,fontSize: 18.sp),)),
            ),
            SizedBox(height: 20.h,),
            Container(
              height: 277.h,
...
mainAxisAlignment: MainAxisAlignment.spaceAround,
                  ...
                  Row(
                    ...
                    children: [
                      Text(' Transaction',style: TextStyle(color: Colors.white,fontSize: 12.sp),),

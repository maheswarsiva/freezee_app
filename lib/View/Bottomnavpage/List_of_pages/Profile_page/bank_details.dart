        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Center(child: Text('Bank Details',style: TextStyle(color: Colors.white,fontSize: 18.sp),)),
            ),
            SizedBox(height: 20.h,),
            Container(
              height: 350.h,
              ...
              child: Column(
                ...
                children: [
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                              ...
                              hintStyle: TextStyle(fontSize: 12.sp,color: Color(0xffF2F3F2).withOpacity(0.2)),
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceAround,
                    children: [
                      Text(' AC/no',style: TextStyle(color: Colors.white,fontSize: 12.sp),),
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                              ...
                              labelStyle: TextStyle(fontSize: 12.sp,color: Color(0xffF2F3F2).withOpacity(0.2)),
                              border: OutlineInputBorder(
                                  borderSide: BorderSide.none
                              )
                          ),
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceAround,
                    children: [
                      Text(' IFSC',style: TextStyle(color: Colors.white,fontSize: 12.sp),),
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceAround,
                    children: [
                      Text(' PAN no',style: TextStyle(color: Colors.white,fontSize: 12.sp),),

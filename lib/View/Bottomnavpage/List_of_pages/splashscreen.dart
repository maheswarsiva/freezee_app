...
class _SplashScreenState extends State<SplashScreen> {
  ...
  //  bool _isLogged = AppHelpers.SHARED_PREFERENCES.getBool('isLogged') ?? false;
    Future.delayed(const Duration(milliseconds: 3500), () => Navigator.pushReplacement(
        context,
        PageTransition(
            type: PageTransitionType.fade,
            child: _isLogged ? const Signin() : const BottomNav(),
            duration: const Duration(
                milliseconds: 350))));
    WidgetsBinding.instance.addPostFrameCallback((_) => setState(() => _isLogged = true));
    super.initState();
  }
